...
export const errTemplate = (type, textContent) => html<ErrorMessage>`
<span>${iconMap[type]}</span> <span>${textContent}</span>`;

export class ErrorMessage extends FASTElement {
  @attr({ attribute: 'type' }) @observable type!: 'warning' | 'error';
